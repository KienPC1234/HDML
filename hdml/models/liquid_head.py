...
class CfCActionFilter(nn.Module):
    """
    Closed-Form Continuous-Time (CfC) Action Filter for HDML-V2.
    Takes the raw action chunk generated by Flow Matching and applies an adaptive
    time-constant liquid filter to smooth out high-frequency noise and chattering.
    """
    def __init__(
        self,
        action_dim: int,
