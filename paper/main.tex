...
To ensure complete reproducibility, the entire codebase, training pipelines, pre-trained foundation checkpoints (\texttt{hdml\_foundation\_best.pt}, 64MB), and evaluation logs are archived with permanent Digital Object Identifier (DOI) \href{https://doi.org/10.5281/zenodo.22020016}{\textbf{10.5281/zenodo.22020016}} and made publicly available under the Apache 2.0 License at:
\begin{center}
